...
from ahaocode.agents.fork import FORK_BOILERPLATE_TAG, ForkError, build_forked_messages
...
from ahaocode.conversation import ConversationManager, ToolUseBlock
...
def verify_notification():
    ...
    from ahaocode.agents.task_manager import BackgroundTask
...
def verify_permission():
    print("\n== 8. BYPASS 权限模式 ==")
    from ahaocode.permissions.modes import PermissionMode, mode_decide
...
def verify_agent_tool():
    ...
    from ahaocode.tools.agent_tool import AgentTool, AgentToolParams
