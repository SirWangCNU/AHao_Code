...
from ahaocode.agents.parser import AgentDef, AgentParseError, parse_agent_file, parse_frontmatter
...
from ahaocode.agents.fork import (
    FORK_BOILERPLATE_TAG,
    ForkError,
    build_forked_messages,
)
from ahaocode.agents.trace import TraceManager, TraceNode
from ahaocode.agents.task_manager import BackgroundTask, TaskManager
from ahaocode.agents.notification import format_task_notification, inject_task_notifications
from ahaocode.conversation import ConversationManager, Message, ToolResultBlock, ToolUseBlock
...
class TestAgentLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path):
        agents_dir = tmp_path / ".ahaocode" / "agents"
...
class TestAgentToolParams:
    def test_required_fields(self):
        from ahaocode.tools.agent_tool import AgentToolParams
