...
from ahaocode.serialization import build_messages
...
SESSION_SUBDIR = ".ahaocode/session/tool-results"
...
async def auto_compact(
    ...
    for attempt in range(max_retries):
        try:
            from ahaocode.tools.base import StreamEnd, StreamEvent, TextDelta
