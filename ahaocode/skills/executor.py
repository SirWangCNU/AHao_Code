...
from ahaocode.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from ahaocode.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from ahaocode.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
