...
from ahaocode.tools.base import Tool, ToolResult
...
if TYPE_CHECKING:
    ...
    from ahaocode.client import LLMClient
...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from ahaocode.agents.fork import ForkError, build_forked_messages
        from ahaocode.agents.parser import AgentDef
        from ahaocode.agents.tool_filter import clone_registry_for_fork, resolve_agent_tools
        from ahaocode.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from ahaocode.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from ahaocode.agents.fork import ForkError, build_forked_messages
        from ahaocode.agents.parser import AgentDef
        from ahaocode.agents.tool_filter import build_teammate_tools
        from ahaocode.agent import Agent as AgentClass
        from ahaocode.conversation import ConversationManager
        from ahaocode.permissions import (
            DangerousCommandDetector,
        ...
        from ahaocode.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from ahaocode.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from ahaocode.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from ahaocode.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from ahaocode.client import create_client
