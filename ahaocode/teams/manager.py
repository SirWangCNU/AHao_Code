...
from ahaocode.teams.backend_detect import BackendDetectionError, detect_backend
from ahaocode.teams.mailbox import Mailbox, create_message
...
from ahaocode.teams.progress import TeammateProgress
from ahaocode.teams.registry import AgentNameRegistry
from ahaocode.teams.shared_task import SharedTaskStore
from ahaocode.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from ahaocode.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
