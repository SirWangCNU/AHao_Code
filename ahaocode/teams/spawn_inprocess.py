...
from ahaocode.teams.progress import TeammateProgress, random_verb

if TYPE_CHECKING:
    from ahaocode.agent import Agent
    from ahaocode.conversation import ConversationManager
    from ahaocode.teams.models import TeammateInfo
    ...
    async def _run() -> str:
        ...
        try:
            if conversation is not None:
                ...
                from ahaocode.conversation import ConversationManager as CM
                conv = CM()
