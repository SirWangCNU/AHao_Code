...
"""Ahaocode 的系统提示词（system prompt）构建。"""
...
IDENTITY_SECTION = PromptSection(
    ...
    priority=0,
    content=(
        "You are Ahaocode, an AI programming assistant running in the terminal. "
...
def build_system_prompt(
    ...
    if coordinator_mode:
        from ahaocode.teams.coordinator import get_coordinator_system_prompt
