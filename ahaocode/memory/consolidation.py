...
from ahaocode.memory.auto_memory import ENTRYPOINT_NAME, MAX_ENTRYPOINT_LINES
from ahaocode.memory.session import SessionManager
...
class MemoryConsolidator:
    ...
    def __init__(
        ...
        *,
        ...
        self._mem_dir = os.path.join(work_dir, ".ahaocode", "memory")
        self._user_mem_dir = os.path.join(Path.home(), ".ahaocode", "memory")
    ...
    async def _do_consolidation(
        ...
        from ahaocode.tools.bash import BashTool
        from ahaocode.tools.edit_file import EditFileTool
        from ahaocode.tools.glob import GlobTool
        from ahaocode.tools.grep import GrepTool
        from ahaocode.tools.read_file import ReadFileTool
        from ahaocode.tools.write_file import WriteFileTool

        transcript_dir = os.path.join(self._work_dir, ".ahaocode", "sessions")
