...
def build_teammate_tools(
    ...
    from ahaocode.tools.send_message import SendMessageTool
    from ahaocode.tools.task_create import TaskCreateTool
    from ahaocode.tools.task_get import TaskGetTool
    from ahaocode.tools.task_list import TaskListTool
    from ahaocode.tools.task_update import TaskUpdateTool
...
def clone_registry_for_fork(parent_registry: ToolRegistry) -> ToolRegistry:
    ...
    from ahaocode.tools.agent_tool import FORK_QUERY_SOURCE
