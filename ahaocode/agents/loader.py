...
PROJECT_AGENTS_DIR = ".ahaocode/agents"
USER_AGENTS_DIR = "~/.ahaocode/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("ahaocode.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from ahaocode.agents.parser import parse_frontmatter, _validate_agent_meta
