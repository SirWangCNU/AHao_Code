...
from ahaocode.permissions.dangerous import DangerousCommandDetector, is_safe_command
from ahaocode.permissions.modes import DecisionEffect, PermissionMode, mode_decide
from ahaocode.permissions.rules import RuleEngine, extract_content
...
class PermissionChecker:
    ...
    def _is_plan_file(self, target_path: str) -> bool:
        if not self.plan_file_path or not target_path:
            return ".ahaocode/plans/" in target_path
        try:
